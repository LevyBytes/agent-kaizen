...
Catalog of the skill packages currently surfaced under `.agents/skills/`, with their covered entities and overlaps. Package validation and host policy remain authoritative; this file is a generated discovery view.
