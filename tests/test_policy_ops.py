...
class PolicyOpsTest(IsolatedDBTest):
    """Policy command coverage for authority rules, defaults, snapshots, and denials."""
...
class PriorityWindowTest(IsolatedDBTest):
    ...
    def _add(self, title: str, priority: str) -> str:
        """Add a learning fixture with the supplied priority and timestamp for A4 window assertions."""
